...
id3ed is a program for the editing of id3-tags. id3ed-fixes is a set of patches
to tidy up id3ed, which is no longer in development.
...
used with -[SNAYCKG] to choose which fields to print, and with -q to to omit the 
field name, and the tag version.
...
More install info: ./configure --help
